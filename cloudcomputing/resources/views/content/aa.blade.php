...
<div class="container-fluid move-down">
  ...
  @foreach($topTenData as $key => $value)
    <input id="topChartData{{ $key+1 }}" name="topChartData{{ $key+1 }}" type="hidden" value="{{ $value->aa }}" data-word="{{ $value->words }}" data-token="{{ csrf_token() }}">
  @endforeach
    ...
    <table class="table table-hover table-striped">
      <thead>
        <tr>
          ...
          <th>Vocabulary</th>
          <th>Total count</th>
          <th class="danger">Anthropology & Archaeology</th>
          <th>Art</th>
          <th></th>
          <th>Astronomy</th>
          <th>Biology & Ecology</th>
          <th>Geology & EarthScience</th>
          <th>Science</th>
          <th>SocialScience</th>
          <th></th>
        </tr>
